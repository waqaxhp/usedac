  ...
  return (
    <div className="bg-gray-50 py-10">
      <div className="container mx-auto px-4 lg:px-20">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl font-bold text-green-800 mb-6">
            Buy & Sell AC Units with Trusted Experts
          </h2>
          <p className="text-lg md:text-xl text-green-900 font-medium">
            We provide high-quality AC units for sale along with reliable buying
            and selling services. Whether you are looking for a brand-new AC, a
            used unit, or want to sell your old AC, we offer the best deals with
            trusted service, fair pricing, and customer satisfaction.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-6">
              In today’s fast-paced life, having a reliable cooling system is
              essential. That’s why we offer a wide range of AC units including
              split ACs, window ACs, and inverter models at affordable prices.
              Our platform connects buyers and sellers for hassle-free deals and
              transparent transactions.
            </p>

            <p className="text-gray-700 text-base md:text-lg leading-relaxed">
              Whether you want to purchase a new AC, upgrade your old system, or
              sell your used AC, we make the process simple and secure. Our
              trusted services are available for customers looking for quality
              products and quick solutions. Explore the best AC deals today and
              enjoy a comfortable environment at home or office.
            </p>
          </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <img
              src="/Content/Images/ac  (8).jpg"
              alt="AC Buying and Selling Illustration"
              className="max-w-full h-auto"
            />
          </div>
        </div>
